; Credit: https://autocadtips1.com/2011/11/03/autolisp-continue-polyline/


(defun C:`c () (C:dimContinue) (princ))
(defun C:dimContinue (/ dat c elst wid ename pend pt) 
  (vl-load-com)
  (setvar "cmdecho" 0)
  ...
  (if 
    ...
    (progn 
      ...
      (if (and pt (wcmatch (cdadr (entget (entlast))) "*POLYLINE*")) 
