...
(defun CXTTestPara (/) 
  ...
  (princ "发热区宽度: ") (princ *CXTHeatingAreaGrossWidth*) (princ "\n")
  (princ "发热区净长度: ") (princ *CXTHeatingAreaNetLength*) (princ "\n")
  (princ "发热区净宽度: ") (princ *CXTHeatingAreaNetWidth*) (princ "\n")
  (princ "发热区面积: ") (princ *CXTHeatingAreaGrossArea*) (princ "\n")
  (princ "发热区净面积: ") (princ *CXTHeatingAreaNetArea*) (princ "\n")
  (princ "发热丝基本损耗: ") (princ *CXTHeatingWireLossBasic*) (princ "\n")
  (princ "发热丝总损耗: ") (princ *CXTHeatingWireLossTotal*) (princ "\n")
  (princ "发热丝初设线宽: ") (princ *CXTHeatingWireInitialWidth*) (princ "\n")
  (princ "发热丝设计线宽: ") (princ *CXTHeatingWireDesignWidth*) (princ "\n")
  (princ "发热丝真实线宽: ") (princ *CXTHeatingWireRealWidth*) (princ "\n")
  (princ "发热丝组数: ") (princ *CXTHeatingWireSet*) (princ "\n")
  (princ "电阻: ") (princ *CXTHeatingWireResistance*) (princ "\n")
  (princ "电阻率: ") (princ *CXTHeatingWireResistivity*) (princ "\n")
  (princ "发热丝厚度: ") (princ *CXTHeatingWireThickness*) (princ "\n")
  (princ "比值: ") (princ *CXTHeatingWireThinFilmResistivityMeasurement*) (princ "\n")
  (princ "线长: ") (princ *CXTHeatingWireLength*) (princ "\n")
  (princ "沿长边布线发热丝数: ") (princ *CXTHeatingWireAlongAreaLengthCount*) (princ "\n")
  (princ "沿长边布线发热丝中心距离: ") (princ *CXTHeatingWireAlongAreaLengthAxisSpacing*) (princ "\n")
  (princ "沿长边布线发热丝边缘距离: ") (princ *CXTHeatingWireAlongAreaLengthOutlineGrossSpacing*) (princ "\n")
  (princ "沿长边布线发热丝边缘设计距离: ") (princ *CXTHeatingWireAlongAreaLengthOutlineDesignSpacing*) (princ "\n")
  (princ "沿长边布线发热丝设计线宽间距比值: ") (princ *CXTHeatingWireAlongAreaLengthWireWidthSpacingRatio*) (princ "\n")
  (princ "沿短边布线发热丝数: ") (princ *CXTHeatingWireAlongAreaWidthCount*) (princ "\n")
  (princ "沿短边布线发热丝中心距离: ") (princ *CXTHeatingWireAlongAreaWidthAxisSpacing*) (princ "\n")
  (princ "沿短边布线发热丝边缘距离: ") (princ *CXTHeatingWireAlongAreaWidthOutlineGrossSpacing*) (princ "\n")
  (princ "沿短边布线发热丝边缘设计距离: ") (princ *CXTHeatingWireAlongAreaWidthOutlineDesignSpacing*) (princ "\n")
  (princ "沿短边布线发热丝设计线宽间距比值: ") (princ *CXTHeatingWireAlongAreaWidthWireWidthSpacingRatio*) (princ "\n")
)